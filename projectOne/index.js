    ...
    form.addEventListener('submit', (e)=>{
        ...
        task_edit_botton.addEventListener('click', ()=>{
            ...
            if (task_edit_botton.innerText.toLowerCase() =="edit") {
                    ...
                    task_input.focus();
                    task_edit_botton.innerText = "Saqlash";
                    task_input.style.textDecoration="yo'q";
            }else{
                task_input.setAttribute("readonly", "readonly");
        ...
        task_delete_button.addEventListener('click', ()=>{
            if (confirm("Haqiqatan ham bu vazifani oʻchirib tashlamoqchimisiz?")) {
